...
| CSeed | **Capability-seed slice** — universal CRM/Workflow/Analytics nav gating (new-company seed bridge) | Build | R4B, BU | Med | Low–Med | next | 🟡 design in review (`CAPABILITY-SEED.md`) |
