...
export function AuthAmbientBg({
  ...
  return (
    <div className={cn('pointer-events-none absolute inset-0 overflow-hidden', className)}>
      ...
      <div className="ams-aura absolute -top-24 -end-16 h-96 w-96 rounded-full blur-3xl" style={{ background: 'rgba(232,176,75,0.30)' }} />
      ...
      <div className="ams-aura absolute end-1/3 top-1/3 h-72 w-72 rounded-full blur-3xl" style={{ background: 'rgba(192,57,43,0.35)' }} />
