            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead className="border-b bg-secondary/50 text-muted-foreground">
                  <tr>
                    <th className="p-3 text-right font-medium">{t('sales.invoiceColNumber')}</th>
                    <th className="p-3 text-right font-medium">{t('sales.invoiceColCustomer')}</th>
                    <th className="p-3 text-right font-medium">{t('sales.invoiceColDate')}</th>
                    <th className="p-3 text-left font-medium">{t('sales.invoiceColNet')}</th>
                    <th className="p-3 text-left font-medium">{t('sales.invoiceColPaid')}</th>
                    <th className="p-3 text-left font-medium">{t('sales.invoiceColRemaining')}</th>
