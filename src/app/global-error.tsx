      ...
      <body style={{ margin: 0, fontFamily: 'system-ui, sans-serif', background: '#f5f5f5' }}>
        <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16 }}>
          <div style={{ maxWidth: 420, width: '100%', background: '#fff', borderRadius: 16, padding: 32, textAlign: 'center', boxShadow: '0 1px 4px rgba(0,0,0,.08)' }}>
            <div style={{ width: 56, height: 56, borderRadius: '50%', background: '#6366f11a', color: '#6366f1', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px', fontSize: 28 }}>⚠️</div>
            ...
            <button
              onClick={() => reset()}
              style={{ marginTop: 20, height: 44, padding: '0 24px', border: 'none', borderRadius: 8, background: '#6366f1', color: '#fff', fontSize: 15, fontWeight: 600, cursor: 'pointer' }}
            >
              إعادة المحاولة
            </button>
          </div>
