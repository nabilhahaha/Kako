...
export const metadata: Metadata = { title: 'الشروط والأحكام | VANTORA' };

export default function TermsPage() {
  return (
    <LegalShell title="الشروط والأحكام">
      <p className="text-muted-foreground">
        تحكم هذه الشروط استخدامك لنظام VANTORA. باستخدامك للخدمة فأنت توافق عليها بالكامل؛ وإذا لم توافق فيرجى عدم استخدام الخدمة.
      </p>

      <LegalSection heading="١. وصف الخدمة">
        <p>VANTORA نظام لإدارة الأعمال يتيح إدارة المبيعات والمخزون والمحاسبة وفريق العمل، ويتأقلم مع نوع نشاطك (عيادة، مطعم، صالون، تجارة، توزيع وغيرها).</p>
      </LegalSection>
