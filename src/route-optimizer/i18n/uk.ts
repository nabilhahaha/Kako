const uk = {
  translation: {
    ...
    // ─── Порівняння до / після ─────────────────────────────────────
    comparison: {
      title: 'Порівняння до / після',
      before: 'До (поточний розподіл)',
      after: 'Після (оптимізовані маршрути)',
      salesmenCount: 'Кількість торгових представників',
      routesCount: 'Кількість маршрутів',
      customersPerGroup: 'Клієнти (мін / макс / сер)',
      customersPerRoute: 'Клієнти (мін / макс / сер)',
      loadBalance: 'Баланс навантаження',
      estMonthlyKm: 'Приблизний місячний км',
      totalMonthlyKm: 'Загальний місячний км',
      avgSellingTime: 'Середній час продажів',
      distanceSavings: 'Економія відстані',
      betterBalance: 'Покращення балансу',
      minMaxAvgHint: 'Кількість клієнтів показана як мін / макс / сер',
    },
