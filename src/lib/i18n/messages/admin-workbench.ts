...
export const ar = {
  adminWb: {
    ...
    tabPlans: 'الباقة', tabEntitlements: 'الوحدات والصلاحيات', tabBranches: 'الفروع', companyPrompt: 'اختر شركة لعرض تفاصيلها.', save: 'حفظ', active: 'نشطة', inactive: 'موقوفة', plan: 'الباقة', subscriptionEnd: 'نهاية الاشتراك', addBranch: 'إضافة فرع', companiesTitle: 'الشركات', newCompany: 'شركة جديدة', companyName: 'الاسم (إنجليزي)', companyNameAr: 'الاسم (عربي)', toastSaved: 'تم الحفظ.', toastError: 'تعذّر إكمال العملية.', featuresTitle: 'الميزات والتطبيقات', templates: 'القوالب', featuresPrompt: 'اختر مجموعة لعرض ميزاتها.', enabled: 'مُفعّلة', tabDetails: 'التفاصيل', branchPrompt: 'اختر فرعاً لعرض تفاصيله.', branchesTitle: 'الفروع', settingsTitle: 'ابحث في الإعدادات…',
  },
};
