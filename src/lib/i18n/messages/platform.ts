...
export const ar = {
  platform: {
    ...
    companies: {
      ...
      subtitle: 'إدارة جميع الشركات واشتراكاتها من مكان واحد.',
      kpiTotal: 'إجمالي الشركات',
      kpiActive: 'النشطة',
      kpiTrial: 'التجريبية',
      kpiSuspended: 'الموقوفة',
      ...
      filter_all: 'الكل',
      filter_active: 'نشطة',
      filter_trial: 'تجريبية',
      filter_suspended: 'موقوفة',
      tabsAria: 'أقسام لوحة مالك المنصّة',
      tab_overview: 'الرئيسية',
      tab_companies: 'الشركات',
      tab_subscriptions: 'الاشتراكات',
      tab_users: 'المستخدمون',
      tab_modules: 'الموديولات',
      ...
      toastCreatedPartial: 'تم إنشاء الشركة، لكن تعذّر تطبيق بعض إعدادات الخطة/التجربة.',
      create: {
        country: 'الدولة',
        city: 'المدينة',
        plan: 'الخطة',
        plan_free: 'تجريبية',
        plan_standard: 'أساسية',
        plan_pro: 'احترافية',
        plan_unlimited: 'غير محدودة',
        status: 'الحالة',
        statusActive: 'نشطة',
        ...
        pilot: 'تجربة تجريبية (Pilot)',
        sectionIdentity: 'الهوية',
        sectionLocation: 'الموقع',
        sectionPlan: 'الخطة والتجربة',
    ...
    company: {
      ...
      c360: {
        ...
        railRoutePlanner: 'مخطِّط المسارات',
        railFieldVerification: 'التحقق الميداني',
        fvIntro: 'التحقق الميداني من العملاء كوحدة قابلة للتفعيل لهذه الشركة — عرض فقط.',
        fvEnablement: 'حالة التفعيل', fvEnabled: 'مُفعّل', fvDisabled: 'غير مُفعّل',
        fvHealth: 'صحة الوحدة', fvModuleState: 'حالة الوحدة',
        fvTotalCustomers: 'إجمالي العملاء', fvAssigned: 'مُسنَدون', fvVerified: 'تم التحقق',
        fvPending: 'قيد الانتظار', fvOutsideRadius: 'محاولات خارج النطاق',
        fvLastActivity: 'آخر نشاط تحقق', fvNever: 'لا يوجد بعد', fvToday: 'اليوم',
        rpIntro: 'مخطِّط المسارات كوحدة قابلة للتفعيل لهذه الشركة — عرض فقط: التفعيل والاشتراك والإعدادات.',
        rpEnablement: 'حالة التفعيل',
        rpEnabled: 'مُفعّل',
        rpDisabled: 'غير مُفعّل',
        rpPlan: 'الخطة / الاشتراك',
        rpNoPlan: 'لا توجد خطة',
        rpHealth: 'صحة الوحدة',
        rpRoutes: 'المسارات',
        rpJourneyPlans: 'خطط الجولات',
        rpDatasets: 'مجموعات البيانات',
        rpMissions: 'المهام',
        rpRequests: 'الطلبات',
        rpConnectors: 'مصادر البيانات',
        rpModuleState: 'حالة الوحدة',
        rpSettings: 'إعدادات مخطِّط المسارات (عرض فقط)',
        rpNoSettings: 'لا توجد إعدادات.',
        rpAdminLink: 'فتح إدارة مخطِّط المسارات ←',
      ...
      members: {
        ...
        inactiveBadge: 'موقوف',
        toastUserActivated: 'تم تفعيل المستخدم.',
        toastUserDeactivated: 'تم إيقاف المستخدم.',
    ...
    errors: {
      ...
      userNotInCompany: 'المستخدم ليس عضوًا في هذه الشركة.',
...
export const en = {
  platform: {
    ...
    companies: {
      ...
      subtitle: 'Manage all companies and their subscriptions from one place.',
      ...
      tabsAria: 'Platform Owner console sections',
      ...
      toastCreatedPartial: 'Company created, but some plan/trial settings could not be applied.',
      create: {
        country: 'Country',
        city: 'City',
        plan: 'Plan',
        ...
        pilot: 'Pilot engagement',
        sectionIdentity: 'Identity',
        sectionLocation: 'Location',
        sectionPlan: 'Plan & trial',
    ...
    company: {
      ...
      c360: {
        ...
        railRoutePlanner: 'Route Planner',
        railFieldVerification: 'Field Verification',
        fvIntro: 'Field Customer Verification as an enableable module for this company — read-only.',
        fvEnablement: 'Enablement', fvEnabled: 'Enabled', fvDisabled: 'Disabled',
        fvHealth: 'Module health', fvModuleState: 'Module state',
        fvTotalCustomers: 'Total customers', fvAssigned: 'Assigned', fvVerified: 'Verified',
        fvPending: 'Pending', fvOutsideRadius: 'Outside-radius attempts',
        fvLastActivity: 'Last verification', fvNever: 'No activity yet', fvToday: 'Today',
        rpIntro: 'Route Planner as an enableable module for this company — read-only: enablement, subscription, settings.',
        rpEnablement: 'Enablement',
        rpEnabled: 'Enabled',
        rpDisabled: 'Disabled',
        rpPlan: 'Plan / Subscription',
        rpNoPlan: 'No plan',
        rpHealth: 'Module health',
        rpRoutes: 'Routes',
        rpJourneyPlans: 'Journey plans',
        rpDatasets: 'Datasets',
        rpMissions: 'Missions',
        rpRequests: 'Requests',
        rpConnectors: 'Data sources',
        rpModuleState: 'Module state',
        rpSettings: 'Route Planner settings (read-only)',
        rpNoSettings: 'No settings.',
        rpAdminLink: 'Open Route Planner admin →',
    ...
    errors: {
      ...
      userNotInCompany: 'User is not a member of this company.',
