...
export const ar = {
  customers: {
    ...
    requestChangeTitle: 'طلب تغيير بيانات',
    requestChangeHint: 'هذه الحقول للعرض فقط بصلاحيتك. أدخل القيمة المقترحة لإرسال طلب اعتماد.',
    requestChangeReason: 'السبب',
    requestChangeSubmit: 'إرسال طلب التغيير',
    requestChangeSubmitted: 'تم إرسال طلب التغيير للاعتماد.',
    errNothingToRequest: 'لا توجد تغييرات لإرسالها.',
...
export const en = {
  customers: {
    ...
    requestChangeTitle: 'Request a data change',
    requestChangeHint: 'These fields are read-only for your role. Enter a proposed value to submit an approval request.',
    requestChangeReason: 'Reason',
    requestChangeSubmit: 'Submit change request',
    requestChangeSubmitted: 'Change request submitted for approval.',
    errNothingToRequest: 'No changes to submit.',
