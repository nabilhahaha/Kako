...
export const ar = {
  forms: {
    ...
    type: { text: 'نص', number: 'رقم', date: 'تاريخ', dropdown: 'قائمة', multiselect: 'اختيار متعدد', attachment: 'مرفق', image: 'صورة', gps: 'موقع GPS', signature: 'توقيع', section: 'قسم', entity_ref: 'مرجع (اختيار سجل)' },
    entityRef: { entity: 'نوع المرجع', hint: 'يختار المستخدم سجلاً ويُخزَّن معرّفه — مناسب لتوجيه الموافقات حسب المالك.', entities: { customer: 'عميل' } },
    ...
    effect: {
      ...
      type: 'نوع الإجراء',
      types: { record_only: 'تسجيل فقط', update_field: 'تحديث حقل', update_fields: 'تحديث عدة حقول', set_gps: 'تعيين موقع GPS', create_customer: 'إنشاء عميل' },
...
export const en = {
  forms: {
    ...
    type: { text: 'Text', number: 'Number', date: 'Date', dropdown: 'Dropdown', multiselect: 'Multi-select', attachment: 'Attachment', image: 'Image', gps: 'GPS', signature: 'Signature', section: 'Section', entity_ref: 'Reference (record picker)' },
    entityRef: { entity: 'Reference type', hint: 'The user picks a record and its id is stored — ideal for owner-based approval routing.', entities: { customer: 'Customer' } },
    ...
    effect: {
      ...
      type: 'Effect type',
      types: { record_only: 'Record only', update_field: 'Update a field', update_fields: 'Update several fields', set_gps: 'Set GPS location', create_customer: 'Create customer' },
