...
export const ar = {
  inventory: {
    ...
    approvedQty: 'المعتمد',
    difference: 'الفرق',
    partialApproval: 'اعتماد جزئي',
    addSku: '+ إضافة صنف',
    saveAdjust: 'حفظ التعديل',
    adjustReason: 'تعديل المعتمد قبل الاعتماد',
    adjustSaved: 'تم حفظ الكميات المعتمدة',
    added: 'مضاف',
    zeroRemoves: '0 = استبعاد الصنف',
...
export const en = {
  inventory: {
    ...
    adjustReason: 'Approver adjustment before approval',
    adjustSaved: 'Approved quantities saved',
    added: 'added',
    zeroRemoves: '0 = exclude item',
