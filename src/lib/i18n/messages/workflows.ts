...
export const ar = {
  workflows: {
    ...
    toast: { error: 'حدث خطأ', created: 'تم الإنشاء', saved: 'تم الحفظ', deleted: 'تم الحذف', stepAdded: 'تمت إضافة الخطوة', cloned: 'تم النسخ', archived: 'تمت الأرشفة', validated: 'تم التحقّق', published: 'تم النشر', simulated: 'تمت المحاكاة' },
  },
};
...
export const en = {
  workflows: {
    ...
    toast: { error: 'Something went wrong', created: 'Created', saved: 'Saved', deleted: 'Deleted', stepAdded: 'Step added', cloned: 'Cloned', archived: 'Archived', validated: 'Validated', published: 'Published', simulated: 'Simulated' },
  },
};
