...
export const ar = {
  products: {
    ...
    sectionUnits: 'الوحدات والبيع',
    fieldDefaultSellUnit: 'وحدة البيع الافتراضية',
    fieldPurchaseUnit: 'وحدة الشراء',
    fieldSellMode: 'نمط البيع',
    sellModeBase: 'وحدة الأساس فقط',
    sellModeSales: 'وحدة البيع فقط',
    sellModeAll: 'كل الوحدات',
    fieldAllowFractional: 'السماح بالكسور',
    allowFractionalHint: 'السماح بكميات كسرية (مثل كجم/جرام)',
    uomBaseDefault: '(وحدة الأساس)',
...
export const en = {
  products: {
    ...
    sectionUnits: 'Units & Selling',
    fieldDefaultSellUnit: 'Default Sell Unit',
    fieldPurchaseUnit: 'Purchase Unit',
    fieldSellMode: 'Sell Mode',
    sellModeBase: 'Base unit only',
    sellModeSales: 'Sales unit only',
    sellModeAll: 'All units',
    fieldAllowFractional: 'Allow Fractional',
    allowFractionalHint: 'Allow fractional quantities (e.g. Kg/Gram)',
    uomBaseDefault: '(base unit)',
