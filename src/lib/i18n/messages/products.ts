...
export const ar = {
  products: {
    ...
    btnDelete: 'حذف',
    delConfirmTitle: 'حذف الصنف: {name}',
    delConfirmMsg: 'سيتم حذف الصنف نهائيًا. لا يمكن التراجع.',
    delConfirmBtn: 'حذف نهائي',
    delSuccess: 'تم حذف الصنف',
    delBlocked: 'لا يمكن الحذف لارتباط الصنف بـ: {reasons}. يمكنك أرشفته (تعطيله) بدلاً من ذلك.',
    delReason: {
      stock: 'رصيد مخزون',
      invoices: 'فواتير',
      returns: 'مرتجعات',
    ...
    delBlockedTitle: 'لا يمكن حذف الصنف',
    delBlockedIntro: 'الصنف مرتبط بالسجلات التالية:',
    delArchiveHint: 'يمكنك أرشفته (تعطيله) بدلاً من الحذف للحفاظ على السجلات.',
    delArchiveBtn: 'أرشفة (تعطيل)',
    delCloseBtn: 'إغلاق',
    delDetail: {
      stock: 'المخزون المتاح: {n} وحدة',
      invoices: 'يظهر في {n} فاتورة',
      returns: 'يظهر في {n} مرتجع',
      exchanges: 'يظهر في {n} عملية استبدال',
      movements: 'له {n} حركة مخزون',
      counts: 'يظهر في {n} عملية جرد',
      adjustments: 'له {n} تسوية مخزون',
    },
...
export const en = {
  products: {
    ...
    btnDelete: 'Delete',
    delConfirmTitle: 'Delete product: {name}',
    delConfirmMsg: 'This permanently deletes the product. This cannot be undone.',
    delConfirmBtn: 'Delete permanently',
    delSuccess: 'Product deleted',
    delBlocked: 'Cannot delete — the product is linked to: {reasons}. Archive (deactivate) it instead.',
    delReason: {
      stock: 'stock balance',
      invoices: 'invoices',
      returns: 'returns',
    ...
    delBlockedTitle: 'Cannot delete product',
    delBlockedIntro: 'This product is linked to:',
    delArchiveHint: 'Archive (deactivate) it instead to keep the records intact.',
    delArchiveBtn: 'Archive (deactivate)',
    delCloseBtn: 'Close',
    delDetail: {
      stock: 'Stock available: {n} units',
      invoices: 'Appears in {n} invoices',
      returns: 'Appears in {n} returns',
      exchanges: 'Appears in {n} exchanges',
      movements: 'Has {n} stock movements',
      counts: 'Appears in {n} stock counts',
      adjustments: 'Has {n} stock adjustments',
    },
