...
export const SCREENS: ScreenHelp[] = [
  ...
  // ── FMCG Value Acceleration Wave 1 screens ──
  { match: '/sales/price-book', title: { en: 'Price Book', ar: 'قائمة الأسعار' },
    purpose: { en: 'Sell prices by unit, quantity, channel/customer and effective dates, with a resolved-price preview.', ar: 'أسعار البيع حسب الوحدة والكمية والقناة/العميل وتواريخ السريان، مع معاينة السعر المحسوب.' },
    actions: [{ en: 'Add a price for a product/unit', ar: 'إضافة سعر لمنتج/وحدة' }, { en: 'Preview the resolved price for a quantity', ar: 'معاينة السعر المحسوب لكمية' }],
    questions: [{ en: 'Why can’t I add a price?', ar: 'لماذا لا أستطيع إضافة سعر؟' }, { en: 'Which price applies for this quantity?', ar: 'أي سعر ينطبق على هذه الكمية؟' }] },
  { match: '/settings/uom', title: { en: 'Units of Measure', ar: 'وحدات القياس' },
    purpose: { en: 'Per-product units, conversion factors and barcodes (e.g. carton = 12 pieces).', ar: 'وحدات المنتج ومعاملات التحويل والباركود (مثال: كرتونة = 12 قطعة).' },
    actions: [{ en: 'Add a unit and its factor', ar: 'إضافة وحدة ومعاملها' }, { en: 'Mark a unit as a case/carton', ar: 'تعليم وحدة كصندوق/كرتونة' }],
    questions: [{ en: 'How do I add a carton unit?', ar: 'كيف أضيف وحدة كرتونة؟' }, { en: 'Why can’t I manage units?', ar: 'لماذا لا أستطيع إدارة الوحدات؟' }] },
  { match: '/distribution/targets-achievement', title: { en: 'Targets & Achievement', ar: 'الأهداف والإنجاز' },
    purpose: { en: 'Create targets and track achievement %, gap, required daily run-rate and forecast.', ar: 'إنشاء الأهداف ومتابعة نسبة الإنجاز والفجوة والمعدل اليومي المطلوب والتوقع.' },
    actions: [{ en: 'Create a target', ar: 'إنشاء هدف' }, { en: 'Show achievement for a target', ar: 'عرض إنجاز هدف' }],
    questions: [{ en: 'How is achievement calculated?', ar: 'كيف يُحسب الإنجاز؟' }, { en: 'What is the required daily run-rate?', ar: 'ما هو المعدل اليومي المطلوب؟' }] },
  { match: '/field/van-reconciliation', title: { en: 'Van Reconciliation', ar: 'تسوية العربة' },
    purpose: { en: 'Enter physical counts per product to compute variance vs the van balance, then settle or reject.', ar: 'أدخل الجرد الفعلي لكل منتج لحساب الفروق مقابل رصيد العربة، ثم اعتمد أو ارفض.' },
    actions: [{ en: 'Compute variances from counts', ar: 'حساب الفروق من الجرد' }, { en: 'Settle or reject a reconciliation', ar: 'اعتماد أو رفض تسوية' }],
    questions: [{ en: 'Why is there a variance?', ar: 'لماذا يوجد فرق؟' }, { en: 'Who can settle a reconciliation?', ar: 'من يستطيع اعتماد التسوية؟' }] },
  { match: '/distribution/returns-analysis', title: { en: 'Returns Analysis', ar: 'تحليل المرتجعات' },
    purpose: { en: 'Returns grouped by reason over a date range, plus the return-reason catalog.', ar: 'المرتجعات مجمّعة حسب السبب خلال فترة، مع كتالوج أسباب المرتجعات.' },
    actions: [{ en: 'Run the report for a period', ar: 'تشغيل التقرير لفترة' }, { en: 'Manage return reasons', ar: 'إدارة أسباب المرتجعات' }],
    questions: [{ en: 'Which reason drives the most returns?', ar: 'أي سبب يسبب أكثر المرتجعات؟' }] },
  { match: '/distribution/credit-requests', title: { en: 'Credit-limit Requests', ar: 'طلبات حد الائتمان' },
    purpose: { en: 'Review and approve/reject customer credit-limit change requests.', ar: 'مراجعة طلبات تغيير حد ائتمان العملاء واعتمادها أو رفضها.' },
    actions: [{ en: 'Approve with an amount', ar: 'اعتماد بمبلغ' }, { en: 'Reject a request', ar: 'رفض طلب' }],
    questions: [{ en: 'Why can’t I approve a credit request?', ar: 'لماذا لا أستطيع اعتماد طلب ائتمان؟' }] },
  { match: '/distribution/sales-summary', title: { en: 'Sales Summary', ar: 'ملخص المبيعات' },
    purpose: { en: 'Aggregated sales, collection and coverage KPIs over a window, by branch.', ar: 'مؤشرات المبيعات والتحصيل والتغطية المجمّعة خلال فترة، حسب الفرع.' },
    actions: [{ en: 'Filter by date and branch', ar: 'التصفية حسب التاريخ والفرع' }],
    questions: [{ en: 'What is my outstanding balance this month?', ar: 'ما هو رصيدي المتبقي هذا الشهر؟' }] },
];
