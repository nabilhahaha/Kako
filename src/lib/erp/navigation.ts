...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'nav.items.fvMyForms', href: '/field-verification/my-forms', icon: ClipboardList, perm: ['forms.fill', 'field_verification.verify'] },
      ...
      { label: 'nav.items.fvForms', href: '/field-verification/forms', icon: FileText, perm: ['forms.admin', 'field_verification.admin'], group: 'nav.groups.fvAdmin' },
      ...
      { label: 'nav.items.fvFormsReports', href: '/field-verification/forms/reports', icon: ClipboardList, perm: ['forms.reports', 'field_verification.reports'], group: 'nav.groups.fvReports' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'nav.items.journeyBuilder', href: '/distribution/journey-builder', icon: CalendarDays, perm: 'reports.view', module: ['distribution', 'route_management'], group: 'nav.groups.coverage' },
