...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'nav.items.fvMyForms', href: '/field-verification/my-forms', icon: ClipboardList, perm: 'field_verification.verify' },
      ...
      { label: 'nav.items.fvForms', href: '/field-verification/forms', icon: FileText, perm: 'field_verification.admin', group: 'nav.groups.fvAdmin' },
      ...
      { label: 'nav.items.fvFormsReports', href: '/field-verification/forms/reports', icon: ClipboardList, perm: 'field_verification.reports', group: 'nav.groups.fvReports' },
