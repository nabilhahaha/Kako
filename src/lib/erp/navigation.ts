...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'nav.items.commercial', href: '/commercial', icon: BarChart3, module: 'field_ops' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'nav.items.erpSync', href: '/settings/sync', icon: ArrowLeftRight, perm: 'settings.users' },
