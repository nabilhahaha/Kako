...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'nav.items.stockMovements', href: '/inventory/movements', icon: Activity, perm: 'fashion.inventory' },
      { label: 'nav.items.varianceReport', href: '/inventory/variance', icon: FileText, perm: 'fashion.inventory' },
      { label: 'nav.items.barcodeLabels', href: '/inventory/labels', icon: ScanBarcode, perm: 'fashion.inventory' },
